...
const socialProviders_index = require('./better-auth.Bl-It_5c.cjs');
require('better-call');
...
async function createTelemetry(options, context) {
  ...
  const disableNotice = options.telemetry?.disableNotice || env.getBooleanEnvVar("BETTER_AUTH_TELEMETRY_DISABLE_NOTICE", false);
