...
import { a3 as socialProviders, B as BASE_ERROR_CODES } from './better-auth.fDN2zET_.mjs';
import 'better-call';
...
async function createTelemetry(options, context) {
  ...
  const disableNotice = options.telemetry?.disableNotice || getBooleanEnvVar("BETTER_AUTH_TELEMETRY_DISABLE_NOTICE", false);
