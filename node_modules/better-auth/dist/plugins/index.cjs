...
const organization = require('../shared/better-auth.BlWIxee_.cjs');
...
const admin = require('../shared/better-auth.3oHgUdBc.cjs');
...
const plugins_oidcProvider_index = require('../shared/better-auth.CKa-q341.cjs');
const plugins_captcha_index = require('./captcha/index.cjs');
const plugins_oneTimeToken_index = require('../shared/better-auth.CdFBGG9K.cjs');
